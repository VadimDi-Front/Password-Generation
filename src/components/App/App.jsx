...
function App() {
  ...
  return (
    <div className={`body ${theme}`}>
      {" "}
      {/* ← добавь класс с темой */}
      <div className="app-wrapper">
        <h2>T O D O</h2>

        <div className="text-password">
          <CreateToDo input={input} setInput={setInput} addTask={addTask} />
        </div>
        <div className="`card-password ${theme}`">
          ...
          <div className="menu-btn">
            <button onClick={() => setFilter("all")} className="menu-btn-style">
              All
            </button>
            <button
            ...
            <button onClick={deleteTask} className="menu-btn-style">
              Clean
            </button>
            <button
